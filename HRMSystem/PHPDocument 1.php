                 ...
                 //echo $res;
                  ...
                  foreach($query as $row){
                   ...
                   echo '<tr class="odd">
                        ...
                        <td>'.$phone_number.'</td>
                        <td>'.$contract_type.'</td>
                        <td class="last"><a href="'.site_url('employees/view_employee/'.$employee_id).'">show</a> | <a href="'.site_url('employees/edit_employee/'.$employee_id).'">edit</a> | <a href="'.site_url('employees/delete_employee/'.$employee_id).'">delete</a></td>
                  </tr>';
                 }
